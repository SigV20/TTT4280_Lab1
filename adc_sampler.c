...
Note; This is the standard delivered code, and the GPIO-pins do not correctly match the ones we have used when running the code on RPi.
This is only for documentation. - Sigve
